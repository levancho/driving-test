const CACHE='nj-road-ready-v2';
const CORE=['./','./index.html','./style.css','./style.css?v=2','./app.js','./app.js?v=2','./engine.js','./questions.js','./questions-ka.js','./i18n.js','./manual-pages.json','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
