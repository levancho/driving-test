const CACHE='nj-road-ready-v9';
const CORE=['./','./index.html','./style.css','./style.css?v=9','./app.js','./app.js?v=9','./engine.js','./states.js','./questions-ny.js','./manual-pages-ny.json','./questions.js','./questions-ka.js','./i18n.js','./manual-pages.json','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
