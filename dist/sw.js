const CACHE='nj-road-ready-v1';
const CORE=['./','./index.html','./style.css','./app.js','./engine.js','./questions.js','./manual-pages.json','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
